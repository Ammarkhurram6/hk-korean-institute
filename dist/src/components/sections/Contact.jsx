...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: <FaEnvelope />,
      title: "Email",
      value: "info@hkkorean.edu",
      sub: "24/7 Support",
    },
    {
      icon: <FaMapMarkerAlt />,
      title: "Address",
      value: "123 Kimchi Plaza, TST",
      sub: "Kowloon, Hong Kong",
    },
    {
      icon: <FaClock />,
      title: "Office Hours",
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="rounded-2xl overflow-hidden shadow-lg h-64 border-4 border-white dark:border-navy/20">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3691.704329128817!2d114.170611314955!3d22.29712898533393!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x340400e7d934b0a9%3A0x6c8b1c0b8b0b8b0b!2sTsim%20Sha%20Tsui!5e0!3m2!1sen!2shk!4v1620000000000"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen=""
